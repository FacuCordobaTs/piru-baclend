...
const facturacionRoute = new Hono()
  .use('*', authMiddleware)
  // Todo este router pertenece a ARCA. El módulo es la única fuente de
  // autorización; la ausencia de suscripción no habilita este acceso.
  .use('*', requireModulo(MODULE_KEYS.FACTURACION_ARCA))
